  ...
  const toast = React.useMemo(
    () => ({
      success: (message: string, title?: string) =>
        addToast({ description: message, title, type: "success" }),
      error: (message: string, title?: string) =>
        addToast({ description: message, title, type: "destructive" }),
      warning: (message: string, title?: string) =>
        addToast({ description: message, title, type: "warning" }),
      info: (message: string, title?: string) =>
        addToast({ description: message, title, type: "info" }),
    }),
    [addToast],
  );
